                    ...
                    <td>
                        <div class="table-data-feature">
                            <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                <i class="zmdi zmdi-edit"><a href="/#/editproduct/${
                                  products.id
                            ...
                            <button data-id="${
                              products.id
                            }" class="item btn-primary btn-remove" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    btns.forEach((btn) => {
      ...
      btn.addEventListener("click", async function () {
        ...
        if (question) {
          ...
          await reRender(Listproduct, "#listproduct");
        }
      });
    });
  },
