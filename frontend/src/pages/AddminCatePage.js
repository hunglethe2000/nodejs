                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <i class="zmdi zmdi-plus"></i><a href="/#/addcategory">ADD Category</a> </button>
                            ...
                            <div class="table-responsive table-responsive-data2" id="listcategory">
