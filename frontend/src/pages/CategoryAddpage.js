...
const CategoryAddpage = {
        ...
        <div class="page-content--bgf7">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Thêm Danh Mục</h3>
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <i class="zmdi zmdi-plus"></i><a href="/#/categories">Category</a></button>
                            ...
                            <div class="table-responsive table-responsive-data2" id="listcategoy">
                                <form id="form-addcategory">
                                    <div class="form-group mb-3">
                                        <label for="category-name" class="form-label">Tên Danh Mục: *</label><br>
                                        <input type="text" class="form-control" placeholder="ten danh muc" id="category-name">
                                        <span class="errorCateName"></span>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="category-image" class="form-label">Ảnh Danh Mục: *</label><br>
                                        <input type="file" class="form-control" placeholder="anh danh muc" id="category-image">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="category-description" class="form-label">Mô Tả: </label><br>
                                        <textarea class="form-control" rows="5" id="category-description" placeholder="..."></textarea>
                                    </div>
                                    <br>
  ...
  async afterRender() {
    $("#form-addcategory").addEventListener("submit", (e) => {
      ...
      if (name == "") {
        console.log($(".errorCateName"));
        $(".errorCateName").innerHTML = "Không được để trống tên danh mục!";
      } else {
        $(".errorCateName").innerHTML = "";
      }
      if (name != "") {
