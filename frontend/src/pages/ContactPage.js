...
<div class="banner_bottom_agile_info">
  ...
  async afterRender() {
    $("#form-contacts").addEventListener("submit", (e) => {
      ...
      if (name == "") {
        $(".errorName").innerHTML = "Không được để trống tên của bạn!";
      } else {
        $(".errorName").innerHTML = "";
      }
      const email = $("#contact-gmail").value;
      if (email == "") {
        $(".errorEmail").innerHTML = "Không được để trống gmail của bạn!";
      } else {
        $(".errorEmail").innerHTML = "";
      }
      const message = $("#contact-message").value;
      if (message == "") {
        $(".errorMessage").innerHTML = "Không được để trống phần này!";
      } else {
