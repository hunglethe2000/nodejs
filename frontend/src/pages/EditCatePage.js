import botAmin from "../components/botAdmin.js";
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i><a href="/#/categories">ListCategory</a></button>
                                ...
                                <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="ten danh muc" id="category-name" value="${
                                              category.name
                                            }">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" rows="5" id="category-description" placeholder="..." >${
