                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <i class="zmdi zmdi-plus"></i><a href="/#/admin">ListProduct</a></button>
                            ...
                            <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="ten san pham" id="product-name" value="${
                                          products.name
                                        }">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" placeholder="gia san pham" id="product-price" value="${
                                          products.price
                                        }">
                                    </div>
                                    <div class="mb-3">
                                            ...
                                            <select name="cars" id="product-status" class="form-control">
                                                ${
                                                  products.status == true
                                                    ? `<option value = "true" selected>Con hang</option>
                                                <option value = "false">Het hang</option>`
                                                    : `<option value = "true" >Con hang</option>
                                                <option value = "false" selected>Het hang</option>`
                                                }
                                            </select>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" placeholder="so luong san pham" id="product-quantity" value="${
                                          products.quantity
                                        }">
                                    </div><br>
